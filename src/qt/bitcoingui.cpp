...
BitcoinGUI::BitcoinGUI(QWidget *parent):
    ...
    nWeight(0)
{
    setFixedSize(855, 525);
	QFontDatabase::addApplicationFont(":/fonts/Arial");
    setWindowTitle(tr("Psilocybin") + "" + tr(""));
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Psilocybin address"));
	...
	nodeAction = new QAction(QIcon(":/icons/address-book"), tr("&Spores"), this);
    nodeAction->setToolTip(tr("Coming soon"));
    nodeAction->setCheckable(true);
    nodeAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_6));
    tabGroup->addAction(nodeAction);
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Psilocybin"), this);
    aboutAction->setToolTip(tr("Show information about Psilocybin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/icons/qtlogo-64"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Psilocybin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Psilocybin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Psilocybin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Psilocybin network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Psilocybin address or malformed URI parameters."));
    }
